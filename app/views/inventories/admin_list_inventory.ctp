...
$class = ' class="altrow"';
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions"><?php echo $this -> Html -> link(__('View', true), array('action' => 'view', $inventory['Inventory']['id']), array('class' => 'view icon', 'title' => __('View', true)));?>
			...
			<?php
				if (isset($inventory['Inventory']['active']) && $inventory['Inventory']['active']) {
