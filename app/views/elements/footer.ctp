	...
	<div class="linea_footer">
		<ul class="tahoma">
			<li>
				...
				<ul class="separacion">
					<li>
						<a class="subtitulos_gris" rel="#overlay" href="/marcas">Marcas</a>
					</li>
				</ul>
				<ul>
					<li>
					...
					<li>
						<a class="subtitulos_gris" rel="#overlay" href="/seguimientoPedidos">Estado del pedido</a>
					</li>
					
				</ul>
				<ul class="separacion">
					<li>
						<a class="subtitulos_gris" href="#">Términos y condiciones</a>
					</li>
					<li>
						<a class="subtitulos_gris" href="#">Política de privacidad</a>
					</li>
				</ul>
				<ul class="separacion">
					<li>
						<a class="subtitulos_gris" href="#">Mapa del sitio</a>
					</li>
				</ul>
			</li>
		</ul>
