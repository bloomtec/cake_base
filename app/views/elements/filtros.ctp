<div class="filtros">
	<?php
		if(isset($cities) && !empty($cities)) { 
			...
			echo $this -> Form -> input('city_id',array('options' => $cities,'label' => __('Qué hay para comer en:', true),'rel'=>__('city',true), 'selected' => $selectedCity));
			echo $this -> Form -> input('zone_id',array('options' => $zones,'label' => __('Barrio:', true),'rel'=>__('zone',true), 'selected' => $selectedZone));
			echo $this -> Form -> input('cuisine_id',array('options' => $cuisines,'label' => __('Cocina:', true),'rel'=>__('cuisine',true), 'selected' => $selectedCuisine));
			echo $this -> Form -> input('price_range',array('options' => $prices,'label' => __('Rango De Precio:', true),'rel'=>__('price',true), 'selected' => $selectedPrice));
		}
	?>
</div>