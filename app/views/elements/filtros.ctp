<div class="filtros">
	<?php
		if(isset($cities) && !empty($cities)) { 
			...
			echo $this -> Form -> input('zone_id',array('options' => $zones,'label' => __('Your Zone:',true),'rel'=>__('zone',true), 'selected' => $selectedZone));
			...
			echo $this -> Form -> input('price_range',array('options' => $prices,'label' => __('Price:',true),'rel'=>__('price',true), 'selected' => $selectedPrice));
		}
	?>
</div>