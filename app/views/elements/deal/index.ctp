...
<div class="deals index">
	...
	<tr<?php echo $class;?> id='<?php echo $deal['Deal']['id'] ?>'>
		...
		<td class="actions">
			<?php
				echo $this->Html->link(__('Ver', true), array('action' => 'view', $deal['Deal']['slug']),array('class'=>'view icon','title'=>__('Ver',true)));
				if($this -> Session -> read('Auth.User.role_id') != 4) {
					echo $this->Html->link(__('Editar', true), array('action' => 'edit', $deal['Deal']['id']),array('class'=>'edit icon','title'=>__('Editar',true)));
					echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $deal['Deal']['id']), array('class'=>'delete icon','title'=>__('Eliminar',true)), sprintf(__('Are you sure you want to delete # %s?', true), $deal['Deal']['id']));
				}
			?>
