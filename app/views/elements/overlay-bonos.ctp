...
<div class="simple_overlay" id="overlay_bonos">
	...
	<div class='body'>
		...
		<ul>
			<li>
				<?php __("Por cada mil pesos en compras que realices recibirás 50 pesos. Este dinero aparecerá al lado derecho de tu pantalla después de realizado tu registro y tu primera compra.")?>
			</li>
			<li>
