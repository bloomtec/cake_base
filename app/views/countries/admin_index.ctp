...
<div class="countries index">
	...
	<tr<?php echo $class;?> id='<?php echo $country['Country']['id'] ?>'>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $country['Country']['id']), array('class'=>'delete icon','title'=>__('Delete',true)), sprintf(__('Are you sure you want to delete # %s?', true), $country['Country']['id'])); ?>
