...
<div class="galleries index">
	...
	?>
	<tr<?php echo $class;?> id='<?php echo $gallery['Gallery']['id'] ?>'>
		<td><?php echo $gallery['Gallery']['name']; ?>&nbsp;</td>
		<td><?php echo $gallery['Gallery']['description']; ?>&nbsp;</td>
		<td><?php echo $gallery['Gallery']['keywords']; ?>&nbsp;</td>
		<td><?php echo $gallery['Gallery']['created']; ?>&nbsp;</td>
		<td><?php echo $gallery['Gallery']['updated']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $gallery['Gallery']['slug']),array('class'=>'view icon','title'=>__('View',true))); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $gallery['Gallery']['id']),array('class'=>'edit icon','title'=>__('Edit',true))); ?>
			<?php echo $this->Html->link(__('Gallery', true), array('controller' => 'gallery_pictures','action'=>'view', $gallery['Gallery']['id']),array('class'=>'view icon','title'=>__('View',true))); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $gallery['Gallery']['id']), array('class'=>'delete icon','title'=>__('Delete',true)), sprintf(__('Are you sure you want to delete # %s?', true), $gallery['Gallery']['id'])); ?>
